        ...
        rl.question(colors.blue('Informe o mês: '), (mes) => {
            rl.question(colors.blue('Informe o ano: '), (ano) => {
                ...
                if (isNaN(dia) || isNaN(mes) || isNaN(ano)) {
                    console.log(
                        '\n    ' + colors.bgRed(' ERRO '),
                        colors.red(`Valores inseridos são inválidos! Certifique-se de digitar números inteiros.\n`)
                    );
                ...
                rl.question(colors.blue('Gostaria de realizar outra verificação de data? [S/N]'), (resultado) => {
